...
tmp_rate_dic = {}
flag = False
save_path = os.path.expanduser('~/save_data/')
save_path_local = os.path.expanduser('~/save_rate/')
cmd_list = ['!c', '!miss', '!list', '!total', '!clear_all',\
            '!graph', '!graphall', '!restore', '!teamgraph']
ERR_CODE_NOT_INT = 11111111111
ERR_CODE_NAN     = 22222222222
USER_ID = s.environ["USER_ID"]
manager = [USER_ID] # permission for clear_all
sp = USER_ID
teamrate = []
